        ...
        <div className="founder-compact-card">
          ...
          <div className="founder-compact-right">
            ...
            <p className="founder-compact-bio">
              Software Engineering student, volunteer at HHRD Chakwal, and builder of NGO Connect. 
        ...
        <div className={`founder-details ${showDetails ? 'open' : ''}`}>
          ...
          <div className="detail-block">
            ...
            <div className="detail-content">
              <p>
                I'm Esha Eman, a software engineering student with a deep-rooted passion for social impact. 
              ...
              <p>
                During my 12-day volunteer service with <strong>HHRD (Helping Hand for Relief & Development)</strong> 
